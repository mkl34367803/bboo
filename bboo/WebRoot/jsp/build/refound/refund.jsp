				...
				<table class="g-table table-list" style="width: 700px;">
					...
					<tbody class="table-bd">
						<tr>
							...
							<td><a href="javascript:void(0)" onclick="getRtMsg()">${buyOrderEntity.pnrCode }</a></td>
						...
						<table class="g-table table-list" >
							...
							<tbody class="table-bd">
								<tr>
									...
									<c:forEach items="${orderDetail.flights}" var="flight" varStatus="i" end="0" >
										<td><input name="face" value="${passenger.price }" type="text" /></td>
										<td><input name="baseFace" value="${passenger.price }" type="text" /></td>
										<td><input name="yq" value="${passenger.oilFee }" type="text" /></td>
										<td><input name="tax" value="${passenger.taxFee }" type="text" /></td>
										<td><input name="rate" value="" type="text" /></td>
										<td><input name="fee" value="" type="text" /></td>
									<script type="text/javascript">
