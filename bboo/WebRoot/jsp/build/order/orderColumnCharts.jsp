			...
			<table class="m-search g-clear g-table">
				<tr class="rows">
					...
					<td class="col">
						...
						<div class="label-info">
							...
							<label class="profitClass"> <input name="type" value="profit" type="radio" class="g-input-check">利润</label>
				...
				<tr class="rows">
					<td class="col" style="width: 190px;">
						...
						<div class="label-info" style="height: 100%; margin-top: 8px;">
							<label class="profitClass"> <input name="isPercent" value="1" type="checkbox" class="g-input-check"></label>
						</div>
					</td>
					<td class="col">
						<span class="label">显示同期</span>
						<div class="label-info" style="height: 100%; margin-top: 8px;">
							<label class="profitClass"> <input name="showTongqi" value="1" type="checkbox" class="g-input-check"></label>
						</div>
					</td>
				</tr>
				<tr class="rows">
